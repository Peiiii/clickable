...
export const providers: Record<string, ProviderInfo> = {
    ...
    'kimi': { name: 'Kimi (Moonshot)', instance: new OpenAICompatibleProvider('https://api.moonshot.cn/v1', 'kimi-k2-thinking') },
    'glm': { name: 'GLM (Zhipu)', instance: new OpenAICompatibleProvider('https://open.bigmodel.cn/api/paas/v4', 'glm-4.6') },
};
